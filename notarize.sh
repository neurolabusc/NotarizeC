...
clang++ -sectcreate TEXT info_plist Info.plist -O3 -o exeX86 hello.cpp -target x86_64-apple-macos10.12 -mmacosx-version-min=10.12
clang++ -sectcreate TEXT info_plist Info.plist -O3 -o exeARM hello.cpp -target arm64-apple-macos11 -mmacosx-version-min=11.0
